...
RSpec.describe "ol3_vector_styles/new", type: :view do
  before(:each) do
    assign(:ol3_vector_style, Ol3VectorStyle.new(
      :name => "MyString",
      :alias => "MyString",
      :stroke_width => 1.5,
      :font_size => 1.5,
  ...
  it "renders new ol3_vector_style form" do
    render

    assert_select "form[action=?][method=?]", ol3_vector_styles_path, "post" do
